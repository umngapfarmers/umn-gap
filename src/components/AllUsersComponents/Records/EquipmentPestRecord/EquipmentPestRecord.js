...
import EquipmentPestTable from './EquipmentPestTable';



class EquipmentPestRecord extends Component {
...
export default connect( mapReduxStateToProps )(withStyles(styles)(EquipmentPestRecord));