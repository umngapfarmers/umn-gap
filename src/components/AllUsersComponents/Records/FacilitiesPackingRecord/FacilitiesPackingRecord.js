...
import FacilitiesPackingTable from './FacilitiesPackingTable';



class FacilitiesPackingRecord extends Component {
  ...
  handleChange = propertyName => {
    ...
    handleSubmit = () => {
      this.props.dispatch({type:'GET_RECORD_PACKING', payload: this.state.selectHarvestYear})
    }
...
export default connect( mapReduxStateToProps )(withStyles(styles)(FacilitiesPackingRecord));