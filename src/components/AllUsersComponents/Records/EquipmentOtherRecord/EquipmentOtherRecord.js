...
import EquipmentOtherTable from './EquipmentOtherTable';



class EquipmentOtherRecord extends Component {
  ...
  handleChange = propertyName => {
    ...
    handleSubmit = () => {
      this.props.dispatch({type:'GET_RECORD_EQUIPMENT_OTHER', payload: this.state.selectHarvestYear})
    }
  ...
  render() {
    ...
    return (
      ...
      <Typography variant="h6" gutterBottom align="center">
        Other Equipment Maintenance Record
      </Typography>
...
export default connect( mapReduxStateToProps )(withStyles(styles)(EquipmentOtherRecord));