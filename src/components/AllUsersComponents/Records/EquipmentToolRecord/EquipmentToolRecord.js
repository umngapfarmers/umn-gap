...
import EquipmentToolTable from './EquipmentToolTable';



class EquipmentToolRecord extends Component {
  ...
  handleChange = propertyName => {
    ...
    handleSubmit = () => {
      this.props.dispatch({type:'GET_RECORD_TOOL', payload: this.state.selectHarvestYear})
    }
...
export default connect( mapReduxStateToProps )(withStyles(styles)(EquipmentToolRecord));