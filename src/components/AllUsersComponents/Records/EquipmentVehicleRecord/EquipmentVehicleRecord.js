...
import EquipmentVehicleTable from './EquipmentVehicleTable';



class EquipmentVehicleRecord extends Component {
  ...
  handleChange = propertyName => {
    ...
    handleSubmit = () => {
      this.props.dispatch({type:'GET_RECORD_VEHICLE', payload: this.state.selectHarvestYear})
    }
...
export default connect( mapReduxStateToProps )(withStyles(styles)(EquipmentVehicleRecord));