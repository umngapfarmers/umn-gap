...
import EquipmentFirstAidTable from './EquipmentFirstAidTable';



class EquipmentFirstAidRecord extends Component {
...
export default connect( mapReduxStateToProps )(withStyles(styles)(EquipmentFirstAidRecord));