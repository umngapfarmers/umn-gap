...
import EquipmentThermometerTable from './EquipmentThermometerTable';



class EquipmentThermometerRecord extends Component {
  ...
  handleChange = propertyName => {
    ...
    handleSubmit = () => {
      this.props.dispatch({type:'GET_RECORD_THERMOMETER', payload: this.state.selectHarvestYear})
    }
  ...
  render() {
    ...
    return (
      ...
      <Typography variant="h6" gutterBottom align="center">
         Thermometer Maintenance Record
      </Typography>
...
export default connect( mapReduxStateToProps )(withStyles(styles)(EquipmentThermometerRecord));