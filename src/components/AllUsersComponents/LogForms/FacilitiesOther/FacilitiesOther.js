...
class FacilitiesOtherLog extends Component {


  state= {
      newFacilityOtherLog :{
        facility_other_date: '',
        farm_facility_other_id: '',
        facility_other_temperature: '',
        facility_other_cleaned: false,
        facility_other_sanitized: false,
        facility_other_area: '',
        facility_other_comment: '',
        facility_other_sig: '',
      }
  }
  ...
  handleChange = (propertyName) => {
    return (event) => {
        this.setState({
            newFacilityOtherLog:{
              ...this.state.newFacilityOtherLog,
  ...
  handleError = () => {
    if (this.state.newFacilityOtherLog.facility_other_date !== '' && this.state.newFacilityOtherLog.farm_facility_other_id !== '' && 
    this.state.newFacilityOtherLog.facility_other_sig !== '') {
    return (
  ...
  handleCheckCleaned = (event) => {
    this.setState({
        newFacilityOtherLog:{
        ...this.state.newFacilityOtherLog,
        facility_other_cleaned: event.target.checked
      }
    })
  }
  ...
  handleCheckSanitized = (event) => {
    ...
    this.setState({
        newFacilityOtherLog:{
        ...this.state.newFacilityOtherLog,
        facility_other_sanitized: event.target.checked
      }
    })
  }
      ...
      alignItems="center">
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={this.handleChange('facility_other_date')}
              value = {
                this.state.newFacilityOtherLog.facility_other_date
              }
            />
          </Grid>
            ...
            <FormControlLabel
              control={
                <Checkbox 
                  ...
                  value={this.state.facility_other_cleaned}
            ...
            <FormControlLabel
              control={
                <Checkbox 
                  ...
                  value={this.state.newFacilityOtherLog.facility_other_sanitized}
          ...
          <Grid item xs={12} sm={6}>
            ...
            margin="normal"
            variant="outlined"
            value={this.state.newFacilityOtherLog.facility_other_comment}
            onChange={this.handleChange('facility_other_comment')}
            style={{width:'80vw', maxWidth:400}}
            /> 
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              id="facility_other_signature"
              select
              label="Select Employee Signature"
              value={this.state.newFacilityOtherLog.facility_other_sig}
              onChange={this.handleChange('facility_other_sig')}
              SelectProps={{
                MenuProps: {
                  className: classes.menu,
                },
...
export default connect( mapReduxStateToProps )(withStyles(styles)(FacilitiesOtherLog));